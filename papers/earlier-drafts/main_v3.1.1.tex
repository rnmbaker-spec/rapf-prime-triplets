...
$p(x|\lambda,\mathcal{A}) = p(x|\lambda)/C_2$ for $x \in \mathcal{A}$. We model
the local gap shape as preserved under this conditioning, with the singular series
acting as a multiplicative scaling factor on the density.
...
% Bibliography generated by Rebecca via RAPF v3.1 pipeline
